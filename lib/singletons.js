...
var SingletonFactory = exports.SingletonFactory = function SingletonFactory(Type) {
  ...
  var preprocessAll = function preprocessAll(_args) {
    ...
    return { args: args, extractedArgs: extractedArgs, unreduceableArgs: unreduceableArgs };
  };
  ...
  var Singleton = function Singleton() {
    ...
    var _preprocessAll = preprocessAll(_args),
        args = _preprocessAll.args,
        extractedArgs = _preprocessAll.extractedArgs,
        unreduceableArgs = _preprocessAll.unreduceableArgs;
  ...
  Singleton.looseKey = function () {
    for (var _len3 = arguments.length, _args = Array(_len3), _key4 = 0; _key4 < _len3; _key4++) {
      _args[_key4] = arguments[_key4];
    }

    var _preprocessAll2 = preprocessAll(_args),
        args = _preprocessAll2.args;

    return Singleton.key.apply(Singleton, _toConsumableArray(args));
  };

  Singleton.looseGet = function () {
    return instances.get(Singleton.looseKey.apply(Singleton, arguments));
  };
